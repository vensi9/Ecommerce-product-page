...
export const ProductImage = () => {
  ...
  const [currentProduct, setCurrentProduct] = useState(Product1); // State for the larger image
  ...
  return (
    <div className='container mx-auto sm:w-96 sm:relative absolute sm:top-0 top-14 '>
      <div className='grid'>
        <div>
          <img src={currentProduct} alt="Product" className='sm:rounded-xl h-[45vh] sm:h-auto w-full object-cover' />
        </div>
        <div className=' gap-4 pt-6 hidden sm:flex justify-between items-center'>
          <div>
            <img src={Product1} alt="Product1"
              // className=' rounded-xl cursor-pointer hover:opacity-50 visited:border-2 visited:border-orange' 
